...
* x_train\/validation\/test: containing float64 with shapes (num_samples, 513, {3,4,1})
...
class_dict = {'1_STORY':0,'2_STORY':1,'3_STORY':2}
...
class unimib_load_dataset(Dataset):
    def __init__(self, 
        ...
        split_subj = dict
                    ...
                    validation_subj = [2],
                    test_subj = [1]),
        one_hot_encode = True, data_mode = 'Train', single_class = False, class_name= '3_STORY', augment_times = None):
        ...
        if (not os.path.isdir('./LosAlamos_Baseline_L1024_t0031')):
            shutil.unpack_archive('./LosAlamos_Baseline_L1024_t0031.zip', '.', 'zip')
        #Convert .mat files to numpy ndarrays
        path_in = './LosAlamos_Baseline_L1024_t0031/data'
        ...
        #UniMiB SHAR has fixed size of 3075 which is 1025 accelX, 1025 accely, 1025 accelz
